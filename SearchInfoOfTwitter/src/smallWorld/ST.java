...
//    private HashMap<Integer,Key> index;
    
    private List<Key> noUse;
...
//        index = new HashMap<Integer,Key>();
//        noUse= new ArrayList<Key>();
    }
...
//    }
    ...
    public Key getRandom(){
    	...
    	if(noUse.size()==0)
    		...
    		now =noUse.get(r.nextInt(noUse.size()));
    	return now;
    }
